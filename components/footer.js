...
function Footer() {
  ...
  return (
    <footer className="pt-10 bg-white relative border-black border font-body">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
            ...
            <form className="flex items-center gap-x-3 md:justify-end">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-3 py-2 text-gray-500 bg-white outline-none border  shadow-sm rounded-full hover:border"
                />
              </div>
              <button className="block py-3 px-4 font-medium text-sm text-center bg-transparent rounded-full hover:bg-black text-black hover:text-white border border-black hover:border-transparent  transition-colors duration-300">
                Subscribe
              </button>
            </form>
          </div>
        </div>
        <div className="flex-2 mt-16 space-y-6 justify-between sm:flex md:space-y-0">
        ...
        <div className="mt-10 py-10 border-t border-black items-center justify-between sm:flex">
